...
enum class Type { CREATE_PLANE, PLANES_FOR_TOWN, TOWNS_FOR_PLANE, PLANES, EXIT, UNKNOWN };

struct Plane { std::vector<std::string> route; };
...
void towns_for_plane(const std::map<std::string, Plane>& db, const std::string& plane);
